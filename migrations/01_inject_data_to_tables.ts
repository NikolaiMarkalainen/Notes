...
module.exports = {
    ...
    up: async ({ context: queryInterface} : MigrationContext) => {
        ...
        await queryInterface.bulkInsert('users', [
            { name: 'John Doe', username: 'johndoe@example.com', password: 'password', team_id: 1, id:1, admin: true },
            { name: 'Jane Smith', username: 'janesmith@example.com', password: 'password', team_id: 1, id:2, admin: false },
            { name: 'Bob Johnson', username: 'bobjohnson@example.com', password: 'password', team_id: 1, id:3, admin: false }
        ]);
